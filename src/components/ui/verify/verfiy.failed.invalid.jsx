    ...
    <div className="max-h-screen w-screen flex flex-row items-center justify-center">
      ...
      <div className="w-full h-screen flex flex-col items-center justify-center space-y-4 md:w-[50%] ">
        ...
        <div className="flex flex-col items-center justify-center space-y-5">
          <h1 className="font-bold  text-red-500  font-poppins text-center  text-[20px] md:text-[20px] lg:text-[30px]">Invalid</h1>
          <h4 className="font-sans font-base  text-gray55 text-center text-[15px] md:text-[15px] lg:text-[20px]">Sudah Aktivasi ?</h4>
          <Link to="/login">
