		...
		<div className="w-full flex flex-col items-start justify-between space-y-2 ">
			...
			>
				<div className="flex flex-row items-center justify-between w-full h-full">
					<p className='font-["Montserrat"] text-sm font-semibold text-gray-800 dark:text-dark-text'>
						{title}
					</p>
					{isOpen ? (
						<div className="flex items-center justify-center h-full">
							<img
								...
								alt="arrow"
								className="h-full border border-[#D0D5DD] dark:border-[#423E3E] rounded-full bg-[#687EFF]"
							/>
						</div>
					) : (
						<div className="flex items-center justify-center h-full">
							<img
								...
								alt="arrow"
								className="h-full border border-[#D0D5DD] dark:border-[#211717] rounded-full block dark:hidden"
							/>
							<img
								src="/Images/ArrowAccordionClosed_DarkMode.png"
								alt="arrow"
								className="h-full border border-[#D0D5DD] dark:border-[#211717] rounded-full hidden dark:block"
							/>
						</div>
					)}
				</div>
					...
					<div className='font-["Montserrat"] text-sm border-l-2 border-neutral-200 dark:border-neutral-700 pl-2 w-full'>
						{contents.map((content, index) => (
							<div
								...
								key={index}
							>
								<p className='text-xs mt-2 font-["Montserrat"] whitespace-nowrap font-semibold text-gray-700 dark:text-dark-text/80'>
									{content.field}
								</p>

								{content.value && (
									<p className='w-full text-xs mt-2 font-["Montserrat"] break-words font-semibold text-gray-900 dark:text-dark-text'>
