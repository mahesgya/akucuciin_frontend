...
function FormPemesanan() {
  ...
  const handleCheckboxChange = (item) => {
    const updatedItems = selectedLaundryContent.includes(item) ? selectedLaundryContent.filter((selectedLaundryContent) => selectedLaundryContent !== item) : [...selectedLaundryContent, item];
  ...
  return (
    <div className=" flex flex-col items-center justify-center mx-[0.5em] my-[2em] flex flex-col items-center justify-center space-y-4">
      ...
      <h1 className="font-bold text-[30px] font-poppins text-center">FORM PEMESANAN</h1>
      <h4 className="font-sans font-base font-[8px] text-gray55 text-center">Silahkan isi kolom-kolom di bawah dengan benar </h4>

      <form onSubmit={handleSubmit} className="space-y-4 flex flex-col items-center bg-white p-6 max-w-md mx-auto">
        <div className="w-[100%]">
          <h4 className="text-lg font-semibold font-sans text-gray-700 mb-4 text-center">Pilih Jenis Laundry</h4>
        ...
        <div className="w-[100%]">
          <h4 className="text-lg font-semibold font-sans text-center text-gray-700 mb-5">Kategori Laundry</h4>
          <div className="space-y-3">
            {laundry_content.map((item) => (
              <label key={item} className="flex items-center space-x-3">
                <input type="checkbox" name="laundry_content" checked={selectedLaundryContent.includes(item)} onChange={() => handleCheckboxChange(item)} className="form-checkbox h-5 w-5 text-blue-600 rounded focus:ring-blue-400" />
            ...
            <label className="flex items-center space-x-3">
              <input
                ...
                onChange={(e) => setFormData({ ...formData, laundry_content_other: e.target.value })}
                type="text"
        ...
        <div className="flex flex-col w-[100%]">
          <h4 className="text-lg font-semibold text-gray-700 mb-2 text-center font-sans ">Masukkan Link Google Maps Anda</h4>
          <input
            required
            value={formData.gmaps_pinpoint}
            onChange={(e) => setFormData({ ...formData, gmaps_pinpoint: e.target.value })}
            type="text"
          ...
          <div className="flex flex-row space-x-1 items-center justify-start">
            ...
            <a target="_blank" href="https://www.google.com/maps/@-6.5585586,106.7345455,14z?entry=ttu&g_ep=EgoyMDI0MTExMy4xIKXMDSoASAFQAw%3D%3D" className="text-base font-normal text-blue-500 mb-2 mt-2">
              Google Maps
            </a>
          </div>
        </div>
        ...
        <div className="flex flex-col w-[100%]">
          <h4 className="text-lg font-semibold text-gray-700 mb-2 text-center font-sans">Tanggal Penjemputan</h4>
          <DatePicker
            required
        ...
        <div className="flex flex-col w-[100%]">
          <h4 className="text-lg font-semibold text-gray-700 mb-2 text-center font-sans ">Kode Referral (Jika Ada)</h4>
          <input
        ...
        <div className="flex flex-col w-[100%]">
          <h4 className="text-lg font-semibold text-gray-700 mb-2 text-center font-sans ">Catatan (Opsional)</h4>
          <input
            value={formData.note}
        ...
        <button type="submit" className="shadow-md font-sans w-[200px] bg-[#06d001] text-white font-semibold p-3  rounded-[20px] focus:outline-none focus:ring-2 focus:ring-[#06d001] focus:ring-offset-2 md:w-[200px] lg:w-[240px]">
          Seleseikan Pemesanan
        </button>
      </form>
