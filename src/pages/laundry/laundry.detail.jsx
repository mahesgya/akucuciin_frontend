      ...
      <section className="bg-[#F9FAFB]  flex-grow mx-2 w-full max-w-screen-xl">
        <div className="flex flex-col items-center justify-center w-full ">
          <div className="relative flex flex-col items-center justify-center min-h-[60%] w-full mb-[5rem] lg:mt-[1rem]">
            ...
            <div className="absolute m-4 -bottom-[6rem] z-30 bg-white mt-2 rounded-xl border border-gray-300 p-4 flex flex-col items-center justify-center w-[95dvw] lg:w-[85dvw] lg:rounded-[30px] lg:flex lg:items-start lg:flex-col lg:p-8">
              ...
              <div className="my-2 w-[20.5rem] md:w-[90dvw] lg:w-[80dvw] border-t border-zinc-200 md:my-4"></div>
            ...
            {!searchQuery && (
              <>
                <div className="relative mt-2">
                  ...
                  <div className="my-2 w-[100dvw] md:w-[95dvw] lg:w-[85dvw] border-t border-zinc-200 md:my-4"></div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-5 md:mx-12 w-[100dvw] md:w-[95dvw] lg:w-[85dvw]">
                  {topPicks
                    ...
                    .map((item) => (
                      <div key={item.id} onClick={() => handlePesan(item)} className="relative bg-white shadow-sm border border-gray-300/30 rounded-lg p-6 cursor-pointer w-full min-w-[95dvw] md:min-w-[100px] ">
                        <div className="flex items-start justify-between">
                          <div className="mr-4">
                            <h3 className="font-['Montserrat'] font-semibold text-md text-gray-800 md:text-lg">{item.name}</h3>
            ...
            {filteredPackages.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-4 md:mx-12 w-[100dvw] md:w-[95dvw] lg:w-[85dvw]">
                {filteredPackages
                  ...
                  .sort((a, b) => Number(a.price_text) - Number(b.price_text))
                  .map((item) => (
                    <div key={item.id} onClick={() => handlePesan(item)} className="bg-white shadow-sm border border-gray-300/30 rounded-lg p-6 cursor-pointer w-full min-w-[95dvw] md:min-w-[100px] ">
                      <div className="flex items-start justify-between">
                        <div className="mr-4">
