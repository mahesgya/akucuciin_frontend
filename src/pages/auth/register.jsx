...
const Register = () => {
  ...
  return (
    <div className="min-h-screen w-screen flex flex-row items-center justify-center dark:bg-dark-bg">
      ...
      <div className="register-form relative -screen w-screen flex flex-col items-center justify-center mt-[15px] mb-[20px] lg:mt-0 lg:mb-0 space-y-1 lg:w-[50%] dark:text-dark-text">
        <a href="/">
        ...
        <div className="flex flex-col items-center justify-center space-y-4 md:space-y-6 lg:space-y-4">
          ...
          <h1 className="font-normal font-[#423E3E] text-[20px] font-poppins text-center md:text-[24px] dark:text-dark-text">Register new account</h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col align-center justify-center items-center ">
            <div className="flex flex-col align-center justify-center items-center space-y-3 md:space-y-5 lg:space-y-3">
              ...
              <div className="space-x-1 flex flex-row font-['Montserrat'] bg-white dark:bg-dark-card border border-0.2 border-gray-500/30 dark:border-neutral-700 shadow-sm p-[10px] rounded-lg w-[20rem] md:p-[12px] lg:p-[10px] md:w-[60dvw] lg:w-[30rem]">
                <img src="Images/telephone.webp" alt="" className="w-[25px]" />
                <span className="text-gray-700 dark:text-dark-text font-['Montserrat'] flex items-center">+</span>
                <input
                  required
                  type="tel"
                  name="telephone"
              ...
              <div className="space-x-1 flex flex-row justify-center align-center font-['Montserrat'] bg-white dark:bg-dark-card border border-0.2 border-gray-500/30 dark:border-neutral-700 shadow-sm px-[10px] py-[10px] rounded-lg w-[20rem] md:p-[12px] lg:p-[10px] md:w-[60dvw] lg:w-[30rem]">
          ...
          <div className="border border-0.2 border-gray-500/30 dark:border-neutral-700 shadow-sm rounded-[10px] dark:bg-dark-card  space-y-5 w-[20rem] flex align-center items-center flex-col justify-center md:w-[60dvw] lg:w-[30rem]">
            <button
              onClick={handleOauth}
              className="flex justify-center items-center font-['Montserrat'] w-[19rem] bg-white dark:bg-dark-card p-3 rounded-[10px] md:w-[24rem] focus:outline-none  focus:ring-0.2 focus:ring-gray-500/30 focus:ring-offset-0.2"
            >
              <img src="Images/google.png" className="w-6 h-6" alt="Google Icon" />
              <p className="ml-2 font-['Montserrat'] text-gray-500 dark:text-dark-text text-center text-sm md:text-base">Sign Up with Google</p>
            </button>
          </div>
        </div>

        <p className="font-['Montserrat'] text-gray-500 dark:text-dark-text/80 text-center text-sm py-2 md:text-base  md:py-2 md:mt-4">
          Sudah punya akun? {"  "}
          <Link to="/login">
            <button className="font-['Montserrat'] bg-white dark:bg-transparent text-[#687eff] font-normal md:text-base">Sign In</button>
          </Link>
        </p>
      </div>
    </div>
