  ...
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-start mx-[0.5em] mt-[3em] space-y-8">
      ...
      <div className="flex flex-col items-center justify-center space-y-5">
        <h1 className="font-bold text-[30px] text-blue-500 font-poppins text-center">Email Aktivasi Berhasil!!</h1>
        <h4 className="font-sans font-base font-[20px] text-gray55 text-center">Silahkan Login Untuk Melakukan Pemesanan</h4>
        <Link to="/login">
